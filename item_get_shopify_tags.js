...
define(['N/record','N/https', 'N/search'],function(record,https,search){
  function get_product_tags(context){
    ...
    // shopify app config page https://gumps-official.myshopify.com/admin/apps/private/295382778050
    const user = '07dc4f4ce53608a7e7d086a94f8b8abc'  ; // this is not publicly visible in NS
